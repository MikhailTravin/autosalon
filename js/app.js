 ...
 */
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (creditRangeSum) nouislider.create(creditRangeSum, {
                start: 60,
                behaviour: "snap",
                connect: [ true, false ],
                pips: {
            ...
            if (creditRangeTerm) nouislider.create(creditRangeTerm, {
                start: 5,
                behaviour: "snap",
                connect: [ true, false ],
                pips: {
            ...
            if (productCardRangeSum) nouislider.create(productCardRangeSum, {
                start: 60,
                behaviour: "snap",
                connect: [ true, false ],
                pips: {
